...
export default function Home() {
  return (
    <>
      ...
      <main className="bg-mainBG min-h-screen bg-cover px-5 pb-24 md:hidden lg:hidden xl:hidden landscape:hidden">
        <Link href="/">
          <div className="py-12" />
        </Link>
        <div
        ...
        <Link href="/kohad/tibidabo">
          <div className="flex justify-end">
            <div className="w-2/3 flex flex-wrap mt-20 pl-2">
              ...
              <p className={`${jost.variable} font-jost text-xs`}>
              ...
              <Image
                ...
                width="500"
                height="500"
                className="mt-2 border-4 border-amber-50 shadow-lg"
              />
            </div>
          </div>
        </Link>
        ...
        <Link href="/kohad/boqueria">
          <div className="flex justify-start">
            <div className="w-2/3 flex flex-wrap mt-2 pl-2">
              ...
              <p className={`${jost.variable} font-jost text-xs`}>
                See on munitsipaalturg, mis asub Barcelonas Rambla tänaval.
                Lisaks sellele, et see on koht, kust saab osta igasuguseid
                värskeid tooteid, on see ka turismimagnet.
              </p>
              <Image
                alt=""
                src="/images/boqueria.jpg"
                width="500"
                height="500"
                className="mt-2 border-4 border-amber-50 shadow-lg"
              />
        ...
        <Link href="/kohad/rambla">
          <div className="flex justify-end">
            <div className="w-2/3 flex flex-wrap mt-12 pl-2">
              ...
              <p className={`${jost.variable} font-jost text-xs`}>
                See on tänav Barcelona kesklinnas. Jalakäijate tänav, mis
                ühendab selle keskel asuvat Plaça de Catalunyat Port Velli
                Christopher Columbuse monumendiga. La Rambla moodustab piiri
                idas Barri Gòticu ja läänes El Ravali linnaosade vahel.
              </p>
              <Image
                alt=""
                src="/images/rambla.jpg"
                width="500"
                height="500"
                className="mt-2 border-4 border-amber-50 shadow-lg"
              />
          ...
          <div className="flex justify-end">
            <div className="w-2/3 flex flex-wrap mt-4 pl-2">
              ...
              <p className={`${jost.variable} font-jost text-xs`}>
                ...
                Barcelona Triumfikaarel suurem tsiviilkomponent, mida
                iseloomustab kunstiline, teaduslik ja majanduslik areng.
              </p>
              <Image
                alt=""
                src="/images/triunfo.jpg"
                width="500"
                height="500"
                className="mt-2 border-4 border-amber-50 shadow-lg"
              />
        ...
        <Link href="/kohad/barriGotic">
          <div className="flex justify-start">
            <div className="w-2/3 flex flex-wrap mt-4 pl-2">
              ...
              <p className={`${jost.variable} font-jost text-xs`}>
                Gooti kvartal on linna vanim tuum ja selle ajalooline keskus,
                mis vastab suures osas Vana-Rooma linnale Barcinole. Varem oli
                see tuntud kui &quot;katedraali piirkond&quot;.
              </p>
              <Image
                alt=""
                src="/images/gotico.jpeg"
                width="500"
                height="500"
                className="mt-2 border-4 border-amber-50 shadow-lg"
              />
        ...
        <Link href="/kohad/casaBatllo">
          <div className="flex justify-end">
            <div className="w-2/3 flex flex-wrap mt-8 pl-2">
              ...
              <p className={`${jost.variable} font-jost text-xs`}>
                Casa Batlló on Gaudí kunstilise täiuse peegeldus: see kuulub
                tema naturalistlikku etappi, perioodi, mil arhitekt täiustas oma
                isiklikku stiili, mis on inspireeritud looduse orgaanilistest
                vormidest.
              </p>
              <Image
                alt=""
                src="/images/batllo.jpg"
                width="500"
                height="500"
                className="mt-2 border-4 border-amber-50 shadow-lg"
              />
        ...
        <Link href="/kohad/placaEspanya">
          <div className="flex justify-start">
            <div className="w-2/3 flex flex-wrap mt-4 pl-2">
              ...
              <p className={`${jost.variable} font-jost text-xs`}>
                Barcelona Plaza de España on tuntud oma muljetavaldava
                purskkaevu ja kuulsa hispaania arhitektuuri poolest. See on
                oluline turismisihtkoht, kus korraldatakse sageli suuri sündmusi
                ja festivalid. Plaza de España on ka oluline transpordisõlm,
                kust saab metrooga hõlpsasti juurdepääsu teistele linnaosadele.
              </p>
              <Image
                alt=""
                src="/images/espana.jpg"
                width="500"
                height="500"
                className="mt-2 border-4 border-amber-50 shadow-lg"
              />
          ...
          <div className="flex justify-start">
            <div className="w-2/3 flex flex-wrap mt-4 pl-2">
              ...
              <p className={`${jost.variable} font-jost text-xs`}>
                ...
                spektakulaarseid vaateid. Pedraforca on ka tuntud oma
                geoloogilise eripära poolest, mille tõttu on see looduslikult
                kaitse all.
              </p>
              <Image
                alt=""
