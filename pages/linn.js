  ...
  return (
    <>
      ...
      <main className="bg-secondBG min-h-screen bg-cover px-5 py-24">
        ...
        <Image alt="" src="/images/barcelona.jpg" width="500" height="500" className="mt-8 border-4 shadow-lg" />
        ...
        <Image alt="" src="/images/linn/romano.jpg" width="500" height="500" className="mt-8 border-4 shadow-lg" />
        <Image alt="" src="/images/linn/columnas.jpg" width="500" height="500" className="mt-8 border-4 shadow-lg" />
        ...
        <Image alt="" src="/images/linn/bisbe.jpg" width="500" height="500" className="mt-8 border-4 shadow-lg" />
        <Image alt="" src="/images/linn/medieval.jpg" width="500" height="500" className="mt-8 border-4 shadow-lg" />
        <p className={`${jost.variable} font-jost mt-5 bg-white shadow-lg p-5`}>Keskajal oli Barcelona kaubandus- ja merenduskeskuseks. Sellest ajast pärineb ka Barri Gòtic, Barcelona vanalinn. 19. sajandil kujunes Barcelonast oluline tööstuslinn, kus valmistati tekstiili, masinaid ja toiduaineid. 20. sajandil kujunes linna majanduslikus arengus oluliseks turism, samuti kultuur ja spordiüritused.</p>
        <Image alt="" src="/images/linn/guerra.webp" width="500" height="500" className="mt-8 border-4 shadow-lg" />
        <Image alt="" src="/images/linn/guerra2.jpg" width="500" height="500" className="mt-8 border-4 shadow-lg" />
        ...
        <Image alt="" src="/images/linn/batllo.webp" width="500" height="500" className="mt-8 border-4 shadow-lg" />
        <Image alt="" src="/images/linn/batllo2.jpg" width="500" height="500" className="mt-8 border-4 shadow-lg" />
        <Image alt="" src="/images/linn/parcguell.webp" width="500" height="500" className="mt-8 border-4 shadow-lg" />
        ...
        <Image alt="" src="/images/linn/portvell.jpg" width="500" height="500" className="mt-8 border-4 shadow-lg" />
        <Image alt="" src="/images/linn/portvell2.jpg" width="500" height="500" className="mt-8 border-4 shadow-lg" />
        <Image alt="" src="/images/linn/campnou.webp" width="500" height="500" className="mt-8 border-4 shadow-lg" />
        ...
        <Image alt="" src="/images/linn/boqueria.jpg" width="500" height="500" className="mt-8 border-4 shadow-lg" />
        <Image alt="" src="/images/linn/tapas.jpg" width="500" height="500" className="mt-8 border-4 shadow-lg" />
        <Image alt="" src="/images/linn/churros.jpg" width="500" height="500" className="mt-8 border-4 shadow-lg" />
      </main>
    </>
  );
}
